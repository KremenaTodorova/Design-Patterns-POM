...
namespace DemoQA.QADemoTests.Core
{
    public class WebDriver
    {
        ...
        public void ScreenShots()
        {
            if (TestContext.CurrentContext.Result.Outcome != ResultState.Success)
            {
                ...
                screenshot.SaveAsFile($"{dirPath}\\QADemoTests\\Screenshots\\{TestContext.CurrentContext.Test.FullName}.Png", ScreenshotImageFormat.Png);
            }
        }
